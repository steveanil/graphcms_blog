...
const PostCard = ({ post }) => (
  <div className="bg-white dark:bg-slate-800 shadow-lg rounded-xl p-0 lg:p-7 pb-12 mb-8">
    ...
    <h1 className="transition duration-700 text-center mb-8 cursor-pointer hover:text-blue-600 dark:hover:text-slate-400 text-3xl font-semibold dark:text-slate-50">
    ...
    <p className="text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8 dark:text-slate-200">{post.excerpt}</p>
