    ...
    <>
      <div className="container mx-auto px-10 mb-8">
        <Head lang='en-gb'>
          ...
          <meta name='keywords' content={`${post.title}, Bible, Bible Apologist, bible apologist, Trinity, Jesus Christ, Apologetics, Answering Islam, Islam, Quran, Muhammad, Christianity`}></meta>
